        ...
        <dt className='borange'>what is useEffect()</dt>
                    ...
                    <dd>    4. Timer setup</dd>
                       <dd> 5. Data fetching</dd>
                            <dt>How useEffect works
                            </dt>
                            <dd>
                            1. useEffect takes two arguments:
                                 - A function to run the side effect (first argument)
                                 - An array of dependencies (second argument, optional)
