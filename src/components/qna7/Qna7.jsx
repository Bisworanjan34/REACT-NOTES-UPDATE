  ...
  return (
    <div>
       <dt className='borange'>what is useReducer()</dt>
                        <dd>useReducer is a Hook in React that allows you to manage state with a reducer function. It's an alternative to useState when you need to:
                                <dd>
                      ...
                      <dd>    3. Optimize performance</dd>
                          ...
                          <dd>1. useReducer takes two arguments:
                        ...
                        <dd>1. Reducer: a function that updates state based on actions
